function test_different_RS_model
clc; clear; close all
format short e
tau = 0.7;
...
%     G0 = ones(I, R);
    ...
    tic;[G2, f2, t2, fit2] = uniformkr_Parallel_Multi_SNTF1(Y, G0, (1/2), maxIter, maxTime, tol, tau, computeobj);toc;
%     tic;[G3, f3, t3, fit3] = uniformkr_Parallel_Multi_SNTF1(Y, G0, (1/2), maxIter, maxTime, tol, 0.5, computeobj);toc;
