function [G, Obj, t, fit] = uniformrand_Parallel_Multi_SNTF3(Y, G0, alpha, maxIter, maxTime, tol, tau, r, computeobj)
...
omega = rand(ceil(sqrt(samplerow)), ncol + r)/sqrt(ncol + r);
omega = kr(omega, omega);omega = omega(1 : samplerow, :);
Ymat1 = Ymat1 * omega;
