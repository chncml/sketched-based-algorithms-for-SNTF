function [G, Obj, t, fit] = uniformrand_Parallel_Multi_SNTF1(Y, G0, alpha, maxIter, maxTime, tol, tau, r, computeobj)
...
omega = rand(samplerow^2, ncol + r)/sqrt(ncol + r);
Ymat1 = Ymat * omega;
